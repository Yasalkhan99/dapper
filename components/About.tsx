    ...
    >
      ...
      <div className="relative mx-auto grid max-w-6xl gap-12 px-5 sm:px-8 lg:grid-cols-2 lg:items-center lg:gap-16">
        ...
        <div className="order-1 lg:order-2">
          ...
          <Link
            href="#pricing"
            className="mt-8 inline-flex border-b-2 border-gold pb-1 text-sm font-bold uppercase tracking-[0.2em] text-gold transition-colors hover:border-gold-hover hover:text-gold-hover"
          >
            More about services
          </Link>
        </div>
